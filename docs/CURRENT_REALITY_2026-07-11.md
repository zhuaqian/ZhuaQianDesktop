...
| `src/scripts/run-tests.ps1` | `186` passed / `0` failed |
| `work/zq-desktop/scripts/run-tests.ps1` | `186` passed / `0` failed |
...
- `AgentPlanCommandMapper` maps parsed plan steps to concrete `IAgentCommand` objects and is synchronized in both source trees.
